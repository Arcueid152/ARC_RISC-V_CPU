  ...
  wire         IF2ID_pred_taken_out;
  wire  [31:0] IF2ID_pred_addr_out;
...
IF2ID  IF2ID_inst (
    ...
    .mispredict(EX_mispredict),
    .pred_taken_in(BPU_pred_taken),
    .pred_addr_in(BPU_pred_addr),
    .pred_taken_out(IF2ID_pred_taken_out),
    .pred_addr_out(IF2ID_pred_addr_out)
  );
...
ID2EX  ID2EX_inst (
    ...
    .mispredict(EX_mispredict),
    .pred_taken_in(IF2ID_pred_taken_out),
    .pred_addr_in(IF2ID_pred_addr_out),
    .pred_taken_out(ID2EX_pred_taken_out)
  );
...
EX  EX_inst (
    ...
    .pred_taken_in(ID2EX_pred_taken_out),
  ...
  BPU  BPU_inst (
    ...
    .update_pc(ID2EX_instr_addr_out),
    .actual_taken(EX_jump_en),
    .actual_addr(EX_jump_addr)
  );
